...
namespace WebApplication.Controllers
{
    public class KategoriaCwiczeniaController : Controller
    {
        ...
        // GET: KategoriaCwiczenias/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: KategoriaCwiczenias/Create
        ...
        // GET: KategoriaCwiczenias/Edit/5
        ...
        // POST: KategoriaCwiczenias/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: KategoriaCwiczenias/Delete/5
        ...
        // POST: KategoriaCwiczenias/Delete/5
